...
class Trail(models.Model):
  ...
  route_type = models.OneToOneField(RouteType, on_delete=models.SET_NULL, null=True, blank=True)
  ...
  popularity = models.DecimalField(max_digits=6, decimal_places=4)
...
class Review(models.Model):
  ...
  id = models.UUIDField(default=uuid.uuid4, unique=True, primary_key=True, editable=False)
  trail = models.ForeignKey(Trail, on_delete=models.CASCADE, related_name='rating')
